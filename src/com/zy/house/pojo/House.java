...
public class House {
	...
	public String toString() {
		return "House [hid=" + hid + ", harea=" + harea + ", hxq=" + hxq + ", hdy=" + hdy + ", hceng=" + hceng
				+ ", hroom=" + hroom + ", hacreage=" + hacreage + ", horientation=" + horientation + ", hfinish="
				+ hfinish + ", hsq=" + hsq + ", hlimit=" + hlimit + ", hptss=" + hptss + ", hprice=" + hprice
				+ ", hstate=" + hstate + ", himg=" + himg + ", haddress=" + haddress + ", createtime=" + createtime
				+ ", modifytime=" + modifytime + ", mjBegin=" + mjBegin + ", mjEnd=" + mjEnd + ", jgBegin=" + jgBegin
				+ ", jgEnd=" + jgEnd + "]";
	}
